...
int main(int argc, char ** argv) {
    ...
    SDL_LoadWAV("Gnossienne.wav", &request, &first_sound, &first_sound_byte_count);
    ...
    SDL_LoadWAV("Gymnopedie.wav", &request, &second_sound, &second_sound_byte_count);
    ...
    SDL_LoadWAV("Fantasie.wav", &request, &third_sound, &third_sound_byte_count);
