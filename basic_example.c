...
int main(int argc, char ** argv) {
    ...
    SDL_LoadWAV("data/Gnossienne.wav", &request, &first_sound, &first_sound_byte_count);
    ...
    SDL_LoadWAV("data/Gymnopedie.wav", &request, &second_sound, &second_sound_byte_count);
    ...
    SDL_LoadWAV("data/Fantasie.wav", &request, &third_sound, &third_sound_byte_count);
